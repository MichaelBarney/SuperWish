    ...
    <div class="flex-1 flex items-center justify-center px-4">
      <div class="w-full max-w-md">
        ...
        <div class="text-center mb-10">
          ...
          <h1 class="text-3xl font-bold text-gray-900 mb-2">{{ $t('nav.appName') }}</h1>
          <p class="text-gray-500">{{ $t('landing.tagline') }}</p>
        </div>
        ...
        <div class="mt-12 grid grid-cols-3 gap-4 text-center">
          ...
          <div class="p-4">
            ...
            <p class="text-sm font-medium text-gray-700">{{ $t('landing.trackWishes') }}</p>
          </div>
          <div class="p-4">
            <div class="w-10 h-10 rounded-xl bg-accent-50 flex items-center justify-center mx-auto mb-3">
              <svg class="w-5 h-5 text-accent-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <p class="text-sm font-medium text-gray-700">{{ $t('landing.setDeadlines') }}</p>
          </div>
        </div>
      </div>
    </div>
